...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        p1.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Create-Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(176, 216, 230)));
        add(p1);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Electricity1/icon/signupImage.png"));
